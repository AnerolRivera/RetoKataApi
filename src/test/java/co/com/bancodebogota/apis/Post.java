...
/**
 * Clase que gestiona peticiones POST a la API FakeStore.
 * Implementa validaciones de estado y permite leer el body desde un archivo JSON.
 */
public class Post {
    // Instancia de Gson para formatear JSON de manera legible
    private final Gson gson = new GsonBuilder().setPrettyPrinting().create();
    /**
     * Método para realizar una petición POST a un endpoint específico.
     *
     ...
     */
    public void postRequest(String urlComplement, String jsonFilePath, int expectedStatusCode) {
        try {
            ...
            System.out.println("\n===============================");
            System.out.println(">> Ejecutando POST: " + Configuration.BASE_URL + urlComplement);
